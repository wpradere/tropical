...
const socialLinks = [
  {
    href: "https://www.facebook.com/profile.php?id=61586376003881",
    label: "Facebook",
    icon: (
  ...
  {
    href: "https://www.instagram.com/tropicalandeastconnect/",
    label: "Instagram",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
      ...
      <div className="flex justify-center gap-8 mt-4">
        {socialLinks.map((link) => (
          <Link
            ...
            className="text-white transition-all duration-300 hover:text-gold-400 hover:scale-110"
